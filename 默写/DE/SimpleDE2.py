...
fitness = target_function(populations)
print(populations)
print(fitness)
...
for gen in range(max_generations):
    for i in range(n):
        ...
        # 选择
        trail_fitness = target_function(trail[np.newaxis, :])[0]
    ...
    print(f"gen:{gen}, bestFitness:{best_fitness}, x1:{best_solution[0]}, x2:{best_solution[1]}")
